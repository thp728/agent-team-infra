...
You have 7 subagents to delegate to. Use the Task tool with the agent name:

| Role | Agent Name | Use For |
|------|------------|---------|
...
Launch each subagent using the Task tool, targeting the agent by name from the table above.
